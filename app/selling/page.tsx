...
const page = () => {
  return (
    <div>
      <Hero layout="layout_2" title="High-Quality Shisha<span> Selling </span>for Individuals" badge="Service" text="Experience the highest quality shisha outsourcing service for your business. Increase customer satisfaction and boost your revenue with our premium hookah offerings."/>
